...
- [Architecture](./architecture/overview.md)
  ...
  - [Architecture Decision Records](./architecture/decisions/index.md)
    ...
    - [ADR-014: Platform chat embed](./architecture/decisions/ADR-014-platform-chat-embed.md)
    - [ADR-015: Platform BFF for user-center login](./architecture/decisions/ADR-015-hbcdcagent-bff.md)
...
- [Plugins](./developing/index.md)
  ...
  - [Platform chat embed](./developing/platform-chat-embed.md)
  - [Platform BFF (user-center login)](./developing/hbcdcagent-bff.md)
